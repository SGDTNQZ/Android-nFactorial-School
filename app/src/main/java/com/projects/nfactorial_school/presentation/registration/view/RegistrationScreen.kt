package com.projects.nfactorial_school.presentation.registration.view
...
fun Header(){
    Row(
        ...
        Text(
            text = stringResource(R.string.tvRegister),
